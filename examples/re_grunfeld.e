...
**  randomEffects function.  This program provides estimates for the classic Grunfeld
...
outFE = randomEffects(y, x, grp, 0);

// Call RE with robust SE
outFE = randomEffects(y, x, grp, 1);
